...
{
    /// <inheritdoc />
    public partial class AddAllRequiredTablesAndSeedUsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Active", "This user is active!" },
                    { 2, "Blocked", "This user is blocked!" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2023, 5, 7), "admin", "admin123", 1, 1 },
                    { 2, new DateOnly(2023, 5, 7), "Alex", "778877", 2, 1 },
                    { 3, new DateOnly(2023, 5, 7), "Jon", "11231", 2, 2 }
                });
